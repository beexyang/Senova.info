// POST /api/forgot-password — bypasses Supabase's built-in mailer (whose
...
//      /api/reset-password which exchanges the OTP for an access_token and
//      updates the password.
//
// This means the Site URL setting in Supabase can stay anything — our
// recovery flow never relies on it.
const { applyCors, requireCsrfHeader, isEmail, bounded } = require('../lib/security');
